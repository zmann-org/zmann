...
<div class="bx--grid">
	<div class="bx--row grid-alignment">
		<dds-card-section-carousel
			data-autoid="dds--card-section-carousel"
			children-custom-class=""
		>
			<dds-content-section-heading
				role="heading"
				aria-level="3"
				data-autoid="dds--content-section-heading"
				slot="heading">Resources and Tutorials</dds-content-section-heading
			>
			<dds-content-section-copy data-autoid="dds--content-section-copy" slot="copy"
				><!---->
				<p style="all:unset;">
					Learn and improve your game development skills with Vacaro's extensive resources
					and tutorials available for free.
				</p>
			...
			<dds-carousel data-autoid="dds--carousel">
				<dds-card
					href="https://www.ibm.com/standards/carbon"
				...
				>
					...
					<dds-image
						slot="image"
						alt="example image"
						default-src="https://www.ibm.com/standards/carbon/web-components/67e3b0c0ba3e25f8cd3be0c4452dcacf.jpg"
					...
					<dds-card-footer
						...
						color-scheme=""
						slot="footer"
						parent-href="https://www.ibm.com/standards/carbon"
						href="https://www.ibm.com/standards/carbon"
					>
						<svg
							focusable="false"
